...
use Modules\Accounting\Entities\AccountClass;
...
class AccountsDatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $accounts = [
            ...
            ['master_parent_id' => null, 'is_account' => 1, 'type' => 'active', 'name' => 'Caixa', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 11, 'class_id' => 1, 'parent_id' => null],
            ...
            ['master_parent_id' => 3.1, 'is_account' => 1, 'type' => 'active', 'name' => 'Investimentos em subsidiárias', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 311, 'class_id' => 3, 'parent_id' => 31],
            ['master_parent_id' => 3.1, 'is_account' => 1, 'type' => 'active', 'name' => 'Investimentos associadas', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 312, 'class_id' => 3, 'parent_id' => 31],
            ['master_parent_id' => 3.1, 'is_account' => 1, 'type' => 'active', 'name' => 'Outros Investimentos financeiros', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 313, 'class_id' => 3, 'parent_id' => 31],
            ...
            ['master_parent_id' => 3.2, 'is_account' => 1, 'type' => 'active', 'name' => 'Edifícios industriais', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 3211, 'class_id' => 3, 'parent_id' => 321],
            ['master_parent_id' => 3.2, 'is_account' => 1, 'type' => 'active', 'name' => 'Edifícios administrativos e comerciais', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 3212, 'class_id' => 3, 'parent_id' => 321],
            ['master_parent_id' => 3.2, 'is_account' => 1, 'type' => 'active', 'name' => 'Edifícios para habitação e outros fins sociais', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 3213, 'class_id' => 3, 'parent_id' => 321],
            ['master_parent_id' => 3.2, 'is_account' => 1, 'type' => 'active', 'name' => 'Vias de comunicação e construções afins', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 3216, 'class_id' => 3, 'parent_id' => 321],
            ...
            ['master_parent_id' => 3.8, 'is_account' => 1, 'type' => 'passive', 'name' => 'Activos intangíveis', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 383, 'class_id' => 3, 'parent_id' => 38],
            ...
            ['master_parent_id' => 4.1, 'is_account' => 0, 'type' => 'active', 'name' => 'Clientes c/c', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 411, 'class_id' => 4, 'parent_id' => 41],
            ['master_parent_id' => 4.1, 'is_account' => 1, 'type' => 'active', 'name' => 'Créditos Concedidos', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 4111, 'class_id' => 4, 'parent_id' => 411],
            ['master_parent_id' => 4.1, 'is_account' => 1, 'type' => 'active', 'name' => 'Créditos Cencedidos (Reestruturado)', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 4112, 'class_id' => 4, 'parent_id' => 411],
            ...
            ['master_parent_id' => 4.9, 'is_account' => 0, 'type' => 'active', 'name' => 'Juros a pagar', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 4911, 'class_id' => 4, 'parent_id' => 491],
            ['master_parent_id' => 4.9, 'is_account' => 1, 'type' => 'active', 'name' => 'Juros a Receber de Creditos Concedidos', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 49111, 'class_id' => 4, 'parent_id' => 4911],
            ...
            ['master_parent_id' => 4.9, 'is_account' => 1, 'type' => 'passive', 'name' => 'Outros acréscimos de rendimentos', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 4939, 'class_id' => 4, 'parent_id' => 493],
            ['master_parent_id' => 4.9, 'is_account' => 0, 'type' => 'active', 'name' => 'Gastos diferidos', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 494, 'class_id' => 4, 'parent_id' => 49],
            ...
            ['master_parent_id' => null, 'is_account' => 0, 'type' => 'passive', 'name' => 'Resultados transitados', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 59, 'class_id' => 5, 'parent_id' => null],
            ...
            ['master_parent_id' => 6.1, 'is_account' => 1, 'type' => 'active', 'name' => 'Activos biológicos', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 6113, 'class_id' => 6, 'parent_id' => 611],
            ...
            ['master_parent_id' => 6.3, 'is_account' => 0, 'type' => 'active', 'name' => 'Restantes combustíveis', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 632132, 'class_id' => 6, 'parent_id' => 63213],
            ...
            ['master_parent_id' => 7.2, 'is_account' => 1, 'type' => 'passive', 'name' => 'IVA da prestação de serviços com imposto incluído', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 721, 'class_id' => 7, 'parent_id' => 72],
            ['master_parent_id' => 7.2, 'is_account' => 1, 'type' => 'passive', 'name' => 'Descontos e abatimentos', 'initial_balance' => 0, 'account_number' => null, 'uuid' => 726, 'class_id' => 7, 'parent_id' => 72],
        ...
        foreach ($accs as $acc) {
            Account::where('id', $acc->id)->update([
                'uuid' => join('.', str_split(str_replace('.', '', $acc->uuid))),
                'parent_id' => $acc->parent_id ? join('.', str_split(str_replace('.', '', $acc->parent_id))) : null
            ]);
        }
        $journal_types = [
            [
        ...
        foreach ($journal_types as $type) {
            JournalType::create($type);
        }
        ...
        CostCenter::create([
            'uuid' => '0001',
            'label' => 'Padrão',
            'description' => 'Centro Padrão do sistema!'
        ]);
    }
}